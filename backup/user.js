...
// favorite songs en jquery
$(document).ready(function(){
    let usermail = getCookie('mail');

    if (usermail){
        $.ajax({
            url: `../lib/request.php?action=getLikedSong&mail=${usermail}`,
            type: 'GET',
...
// Function to remove a song from the favorites en jquery
$(document).ready(function(){
    $(document).on('click', '.remove-favorite', function(){
        ...
        if (userMail && songId) {
            $.ajax({
                url: `../lib/request.php?action=removeLikedSong&mail=${userMail}&id_song=${songId}`,
                type: 'GET',
                success: function(data){
                    if (data.success) {
                        location.reload();
